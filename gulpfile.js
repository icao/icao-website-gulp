...
/*VARIABLES PROJECTO */
var projectName = "icao website GULP";
/*-----------------------SCRIPTS TASK-------------------------- */
/* Browser Sync */
...
gulp.task('sass', function() {
    ...
    gulp.src('src/css/sass/*.{scss,sass}')
        ...
        // .pipe(changed('src/css', {extension: '.css'}))//comentar si causa problema
        // .pipe(changed('src/css/sass/**/*', {extension: '.{scss,sass}'})) //comentarsi causa problema
...
gulp.task('copyFiles', function() {
    gulp.src(['src/**/**/*', '!src/js/**/*', '!src/css/**/*'])
        .pipe(changed('dist'))
        //.pipe(changed('dist', {extension: '*.{html,php}'}))
        .pipe(gulp.dest('dist'))
